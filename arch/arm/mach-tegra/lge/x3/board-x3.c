...
#if defined (CONFIG_X3_REBOOT_MONITOR)
...
static void __init x3_uart_init(void)
{
	...
	tegra_uarte_device.dev.platform_data = &x3_uart_pdata;
...
static void __init tegra_x3_ramconsole_reserve(unsigned long size)
{
	struct resource *res;
	long ret;
...
#ifdef CONFIG_X3_REBOOT_MONITOR
...
#endif
	tegra_x3_ramconsole_reserve(SZ_1M);
}
