...
static char ssd2825_14[2] = {0x1c, 0x02};
...
static struct spi_cmd_data init_ssd2825_sequence[] = {
	...
	{  ANALOG_CONTROL_REGISTER_1, 		0, sizeof(ssd2825_14),  ssd2825_14},
};
...
static char power_setting3[10] = {0xC3, 0x00, 0x08, 0x00, 0x00, 0x00, 0x67, 0x88, 0x32,0x02};
...
static char cabc_set1[2] = {0x5E, 0xC0};
static char cabc_set2[2] = {0x53, 0x2C};
static char cabc_set3[2] = {0x55, 0x01};
static char cabc_set4[5] = {0xC8, 0xFF, 0x0F, 0xE3, 0x22};
...
static char cabc_set2[2] = {0x53, 0x2C};
static char cabc_set3[2] = {0x55, 0x01};
static char cabc_set4[5] = {0xC8, 0x11, 0x01, 0xE3, 0x22};
#endif
...
static char power_setting3_test[9] = {0x01, 0x08, 0x00, 0x00, 0x00, 0x67, 0x88, 0x32,0x02};
