...
#define USB_BOOTNSUSPEND_INIT		(USB_VBUS_WAKEUP_EN|USB_VBUS_INT_EN|USB_ID_STATUS|USB_ID_INT_EN)
...
static int tegra_otg_probe(struct platform_device *pdev)
{
	...
	tegra->intr_reg_data = USB_BOOTNSUSPEND_INIT;
...
static int tegra_otg_suspend(struct device *dev)
{
	...
	tegra_otg->intr_reg_data = USB_BOOTNSUSPEND_INIT;
