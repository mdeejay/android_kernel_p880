...
#if 0   //Nvidia Bug 923123 - For Sleep and Reset fixed [Start]
			usb_set_device_state(udev, USB_STATE_CONFIGURED);
#endif  //Nvidia Bug 923123 - For Sleep and Reset fixed [End]
...
static int tegra_ehci_suspend(struct platform_device *pdev, pm_message_t state)
{
	...
	/* indicate the H/W is not accessible to the core driver */
