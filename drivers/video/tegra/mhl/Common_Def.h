...
#define GPIO_MHL_SEL		TEGRA_GPIO_PS2
#else
#define GPIO_MHL_SEL		TEGRA_GPIO_PR3
#endif
#define GPIO_MHL_RST		TEGRA_GPIO_PEE1
#define GPIO_MHL_WAKE_UP	TEGRA_GPIO_PR3


#if defined(MACH_X3_REV_A)
#define GPIO_MHL_LDO_EN		TEGRA_GPIO_PI2 //1.2v, 3.3v
#else
#define GPIO_MHL_LDO_EN		TEGRA_GPIO_PI5
#endif
#define GPIO_GAMBIT_LDO_EN	TEGRA_GPIO_PV2 // 1.8v pull up:hw cfg.
#define GPIO_5V_BOOST_EN	TEGRA_GPIO_PK5 //
