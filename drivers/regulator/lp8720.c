...
static unsigned char lp8720_output_status = 0x00;
...
{  
  int ret;
	...
	lp8720_write_reg(lp8720_client, LP8720_LDO1_SETTING, LP8720_NO_STARTUP | 0x00);
	lp8720_write_reg(lp8720_client, LP8720_LDO2_SETTING, LP8720_NO_STARTUP | 0x17);
	lp8720_write_reg(lp8720_client, LP8720_LDO3_SETTING, LP8720_NO_STARTUP | 0x17);
	lp8720_write_reg(lp8720_client, LP8720_LDO4_SETTING, LP8720_NO_STARTUP | 0x11);
	lp8720_write_reg(lp8720_client, LP8720_LDO5_SETTING, LP8720_NO_STARTUP | 0x19);
	lp8720_write_reg(lp8720_client, LP8720_BUCK_SETTING1, LP8720_NO_STARTUP | 0x09);
	lp8720_write_reg(lp8720_client, LP8720_BUCK_SETTING2, 0x09);
	lp8720_write_reg(lp8720_client, LP8720_OUTPUT_ENABLE, 0x80 | lp8720_output_status);
	lp8720_write_reg(lp8720_client, LP8720_PULLDOWN_BITS, 0xBF);
  udelay(10);
