...
#endif
#define IMX111_RESET_GPIO       84 

#define IMX111_TABLE_WAIT_MS    0
#define IMX111_TABLE_END        1
#define IMX111_MAX_RETRIES      3

#define IMX111_TABLE_WAIT_MS_TIME 30 

#define SIZEOF_I2C_TRANSBUF 32

#if 0
#define IMX111_1080P_SUB_SAMPLING_X3 1 
#endif

#define IMX111_USE_OB_LEVEL_64 1 
...
#if 0
//subsampling(1.667:1.667) Rev5.0, 30fps
static struct imx111_reg mode_1952x1098[] = {
  {0x0100, 0x00},
  {IMX111_TABLE_WAIT_MS, IMX111_TABLE_WAIT_MS_TIME},
