...
struct platform_device *tegra_wdt_dev;
static int heartbeat = 30;
extern int x3_wdt_kick_disabled;
...
void tegra_wdt_enable(struct tegra_wdt *wdt)
{
	u32 val;
...
void tegra_wdt_disable(struct tegra_wdt *wdt)
{
